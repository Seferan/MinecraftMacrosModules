package seferan.macromodules.getslotitemextended.vars;
...
public class VariableProviderExample implements IVariableProvider {
    ...
    public void onInit()
    {
	  ...
	  this.clipboardIntVars = new HashMap();
